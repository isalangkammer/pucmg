/**
 *---------------------------------------------------------------------------
 * TP 05 - QUESTÃO 02 - Pesquisa Binária
...
class ListaPessoa {
	...
	public boolean Pesquisar(int aux) {

		boolean inArray = false;

		for(int i = 0; i < cout; i++) {
	
			if(arrayList[i].getId() == aux) {
	...
	public boolean PesquisaBinaria(int aux) {

		int direita = cout -1, esquerda = 0, meio;
		boolean inArray = false;
		...
		while(esquerda <= direita) {
			...
			else if(aux > arrayList[meio].getId()) {
...
public class TP05Q02 {
	...
	public static void main(String[] args) {
		...
		for(nomeArquivo = MyIO.readLine(); nomeArquivo.equals("####") == false; nomeArquivo = MyIO.readLine()) {
		...
		for(nomeArquivo = MyIO.readLine(); nomeArquivo.equals("FIM") == false; nomeArquivo = MyIO.readLine()) {
			...
			inArray = listapessoa.Pesquisar(Integer.parseInt(nomeArquivo));
