/**
 * Grafo para ler as relações de amizade de uma pessoa
 * Trabalho Prático II - Questões 1 e 2 - AED I
 *
 ...
 */
 ...
 public class grafoAmizade{
   ...
   /**
    * Método para ler o tamanho da matriz
    *
    * @return t tamanho da matriz
    */
   public static int leTamanho() throws Exception {
      int t;
      Scanner scanner=new Scanner(System.in);
      
      System.out.print("Digite o número de pessoas[1 até 100]:");
      t=scanner.nextInt();
      if (t<1 || t>100){
